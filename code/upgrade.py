...
class Item:
    ...
    def display(self, surface, selected_num, name, value, max_value, cost):
        if self.index == selected_num:
        ...
        self.display_names(surface, name, cost, self.index == selected_num)
        self.display_bar(surface, value, max_value, self.index == selected_num)